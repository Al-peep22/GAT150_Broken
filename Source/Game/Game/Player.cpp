...
void Player::Update(float dt)
{
	...
	viper::vec2 force = direction.Rotate(viper::math::degToRad(owner->transform.rotation))*thrust*owner->speed;
	//velocity += force * dt;
	...
	if (viper::GetEngine().GetInput().GetKeyDown(SDL_SCANCODE_F) && owner->fireTimer <= 0) {
